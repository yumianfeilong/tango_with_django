...
{"title":"Learn Python in 10 Minutes",
 "url":"http://www.korokithakis.net/tutorials/python/"} ]
    ...
    cats = {"Python": {"pages": python_pages, "views": 64, "likes":32}, "Django": {"pages": django_pages, "views":32,"likes":16}, "Other Frameworks": {"pages": other_pages, "views":16, "likes":8} }
...
def add_cat(name,views_score,likes_score):
